export const myCoursesSubmenu = [
  ...
  { label: "Current Semester", href: "/student/courses/current-semester", slug: "current-semester" },
  { label: "Completed Courses", sidebarLabel: "Completed", href: "/student/courses/completed", slug: "completed" },
  { label: "Lecture Notes", sidebarLabel: "Notes", href: "/student/courses/lecture-notes", slug: "lecture-notes" },
  { label: "Video Lessons", sidebarLabel: "Videos", href: "/student/courses/videos", slug: "videos" },
  ...
  { label: "Course Progress", sidebarLabel: "Progress", href: "/student/courses/progress", slug: "progress" },
] as const;
